...
import {
  getEffectiveAllowedNavKeys,
  getEffectiveScreenPrivileges,
} from './userAccess';
...
export function jsonUser(user) {
  ...
  if (obj.customScreenPrivileges instanceof Map) {
    obj.customScreenPrivileges = Object.fromEntries(obj.customScreenPrivileges);
  }
  obj.effectiveAllowedNavKeys = getEffectiveAllowedNavKeys(user);
  obj.effectiveScreenPrivileges = getEffectiveScreenPrivileges(user);
  return obj;
}
